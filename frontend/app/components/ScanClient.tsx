...
function ScanBackdrop() {
  return (
    <>
      ...
      <div className="pointer-events-none fixed inset-0 -z-20 bg-[linear-gradient(180deg,rgba(255,255,255,0.16)_0%,rgba(244,246,249,0.34)_48%,rgba(226,231,238,0.74)_100%)]" />
